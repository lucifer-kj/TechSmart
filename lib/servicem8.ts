...
const generateMockJobs = (customerId: string): ServiceM8Job[] => {
  ...
  return [
    ...
    },
    {
      ...
      edit_date: new Date(oneMonthAgo.getTime() + 5 * 24 * 60 * 60 * 1000).toISOString(),
      date: oneMonthAgo.toISOString(),
      completion_date: new Date(oneMonthAgo.getTime() + 7 * 24 * 60 * 60 * 1000).toISOString(),
      active: 1,
      // Backward compatibility fields
      job_number: "ST-1003",
    ...
    {
      uuid: "job-101",
      generated_job_id: "ST-1004",
      company_uuid: customerId,
      job_description: "Emergency air conditioning repair",
      status: "Complete" as const,
      generated_job_total: 320.00,
      total_invoice_amount: "320.00",
      job_address: "101 Elm Street, Perth WA 6000",
      edit_date: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString(),
      date: new Date(now.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString(),
      completion_date: new Date(now.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString(),
      active: 1,
      // Backward compatibility fields
      job_number: "ST-1004",
    ...
    {
      uuid: "job-404",
      generated_job_id: "ST-1007",
      company_uuid: customerId,
      job_description: "Duct cleaning and sanitization",
      status: "Invoice" as const,
      generated_job_total: 420.00,
      total_invoice_amount: "420.00",
      job_address: "404 Birch Court, Darwin NT 0800",
      edit_date: new Date(now.getTime() - 8 * 24 * 60 * 60 * 1000).toISOString(),
      date: new Date(now.getTime() - 10 * 24 * 60 * 60 * 1000).toISOString(),
      completion_date: new Date(now.getTime() - 7 * 24 * 60 * 60 * 1000).toISOString(),
      active: 1,
      // Backward compatibility fields
      job_number: "ST-1007",
